...
// BabylonStakerAddress provides a mock function with given fields: ctx, stakingTxHashHex
func (_m *BbnInterface) BabylonStakerAddress(ctx context.Context, stakingTxHashHex string) (string, error) {
	ret := _m.Called(ctx, stakingTxHashHex)

	if len(ret) == 0 {
		panic("no return value specified for BabylonStakerAddress")
	}
...
func (_m *BbnInterface) GetChainID(ctx context.Context) (string, error) {
	ret := _m.Called(ctx)
...
// GetStakingParams provides a mock function with given fields: ctx, minVersion
func (_m *BbnInterface) GetStakingParams(ctx context.Context, minVersion uint32) (map[uint32]*bbnclient.StakingParams, error) {
	ret := _m.Called(ctx, minVersion)
	...
	var r0 map[uint32]*bbnclient.StakingParams
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32) (map[uint32]*bbnclient.StakingParams, error)); ok {
		return rf(ctx, minVersion)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint32) map[uint32]*bbnclient.StakingParams); ok {
		r0 = rf(ctx, minVersion)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[uint32]*bbnclient.StakingParams)
		}
...
// Subscribe provides a mock function with given fields: ctx, subscriber, query, healthCheckInterval, maxEventWaitInterval, outCapacity
func (_m *BbnInterface) Subscribe(ctx context.Context, subscriber string, query string, healthCheckInterval time.Duration, maxEventWaitInterval time.Duration, outCapacity ...int) (<-chan coretypes.ResultEvent, error) {
	_va := make([]interface{}, len(outCapacity))
	for _i := range outCapacity {
		_va[_i] = outCapacity[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, subscriber, query, healthCheckInterval, maxEventWaitInterval)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration, time.Duration, ...int) (<-chan coretypes.ResultEvent, error)); ok {
		return rf(ctx, subscriber, query, healthCheckInterval, maxEventWaitInterval, outCapacity...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, time.Duration, time.Duration, ...int) <-chan coretypes.ResultEvent); ok {
		r0 = rf(ctx, subscriber, query, healthCheckInterval, maxEventWaitInterval, outCapacity...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, time.Duration, time.Duration, ...int) error); ok {
		r1 = rf(ctx, subscriber, query, healthCheckInterval, maxEventWaitInterval, outCapacity...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *BbnInterface) UnsubscribeAll(ctx context.Context, subscriber string) error {
