...
// TestDependencies contains mocked dependencies for testing
type TestDependencies struct {
	DB *MockDbClientWithBSN
}

// setupTestService creates a test service with mocked dependencies
func setupTestService(t *testing.T) (*TestService, *TestDependencies) {
	_ = t // Intentionally unused in this setup function
...
func TestProcessInstantiateAllowlistEvent(t *testing.T) {
	...
	t.Run("successful instantiate with new allowlist", func(t *testing.T) {
		...
		// Execute
		err := s.processInstantiateAllowlistEvent(ctx, allowlistEvent)
...
func TestProcessAddAllowlistEvent(t *testing.T) {
	...
	t.Run("successful add to existing allowlist", func(t *testing.T) {
		...
		// Execute
		err := s.processAddAllowlistEvent(ctx, event)
...
func TestProcessRemoveAllowlistEvent(t *testing.T) {
	...
	t.Run("successful remove from allowlist", func(t *testing.T) {
		...
		// Execute
		err := s.processRemoveAllowlistEvent(ctx, event)
