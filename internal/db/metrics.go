...
func (d *DbWithMetrics) SaveBTCDelegationCovenantSignature(ctx context.Context, stakingTxHash, covenantBtcPkHex, signatureHex, stakeExpansionSignatureHex string) error {
